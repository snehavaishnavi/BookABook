...
<?php include 'application/view/fx_sidebar.php';?>
    <div id="main-container">	
        ...
        <div class="col-md-12" style="margin-top:35px;background-color: white">
            <div class="row">
                <a href="index.php?op=atHome2"><p><<< Back to main page...</p></a>
            </div>
            <div style="margin-top:220px;margin-left: 250px; background-color: white"><h2>Book is already loaned and is not available....</h2></div>
