        ...
        <div class="col-md-12" style="margin-top:35px;background-color: white">
            <div class="row">
                <div class="col-md-6" style="text-align:center">
                    <a href="index.php?op=reserveRoomA"><img src="assets/img/rooms.png" style="margin:35px 0px"/> </a>
                    <div>Reserved Rooms</div>
                </div>
                <div class="col-md-6" style="text-align:center">
                     <a href="index.php?op=checkBooksA"><img src="assets/img/amblogo.png" height="180px" width="180px"style="margin:35px 0px" /></a>
                    <div>Check Books</div>
                </div>
            </div>
        </div>
